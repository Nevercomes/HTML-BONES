...
<body>
	...
	<form id="imgForm" method="post" action="${pageContext.request.contextPath}/uploadDraft1" enctype="multipart/form-data">
		...
		<h4 class="changeUpload">上传设计图？<a href="${pageContext.request.contextPath}/viewUploadDesignForm">点击这里</a></h4>
